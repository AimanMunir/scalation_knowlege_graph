 ...
 */
class SSShortestPath (c: Array[Array[Double]], s: Int)
{
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    private val n     = c.length                          // the number of vertices
     ...
     */
    def spath (): (Array [Double], Array [Int]) =
    {
        ...
        val p = Array.ofDim [Int] (n)                   // create predecessor vector
        for (j <- rang) {
