...
class SortingR (a: Array [Real])
{
     ...
     *  @see SortingR companion object's 'median3' function
...
object SortingR
{
     ...
     */
    @inline def median3 (a1: Real, a2: Real, a3: Real): Real =
    {
     ...
     */
    def median (a: Array [Real], k_ : Int = -1): Real =
    {
        val n = a.length
        val k = if (k_ < 0) (n+1) / 2 else k_
        (new SortingR (a)).median (k)
    } // median
