...
import scalation.math.TimeO.{TimeNum, _0}
...
class SortingT (a: Array [TimeNum])
{
     ...
     *  @see mitpress.mit.edu/books/introduction-algorithms
     *  @param p  the left cursor
     *  @param r  the right cursor
     */
     ...
     *  @see SortingT companion object's 'median3' function
...
object SortingT
{
     ...
     */
    @inline def median3 (a1: TimeNum, a2: TimeNum, a3: TimeNum): TimeNum =
    {
        null // max (min (a1, a2), min (max (a1, a2), a3))
    } // median3

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Find the median value in the array.
     *  @param a   the array to be examined
     *  @param k_  specification for k-th smallest element
     */
    def median (a: Array [TimeNum], k_ : Int = -1): TimeNum =
    {
        val n = a.length
        val k = if (k_ < 0) (n+1) / 2 else k_
        (new SortingT (a)).median (k)
    } // median
...
object SortingTTest extends App
{
    ...
    println ("--------------------------------------------------------------")
    println ("Test direct: a = " + stringOf (a))
    for (k <- 1 to 5) {
...
object SortingTTest2 extends App
{
    ...
    println ("Test direct: a1 = " + stringOf (a1))
    val srt = new SortingT (a1)
    srt.qsort ()
    println ("qsort a1 = " + stringOf (a1))
    ...
    println ("Test indirect: a2 = " + stringOf (a2))
    val isrt = new SortingT (a2)
    rk = isrt.iqsort ()
    println ("iqsort rk = " + stringOf (rk))                      // rank order
...
object SortingTTest3 extends App
{
    ...
    val srt = new SortingT (a1)
    srt.selsort ()
    println ("selsort a1 = " + stringOf (a1))
    println ("isSorted   = " + srt.isSorted)
    ...
    val isrt = new SortingT (a2)
    rk = isrt.iselsort ()
    println ("iselsort rk = " + stringOf (rk))                      // rank order
    println ("isiSorted   = " + isrt.isiSorted (rk))
...
object SortingTTest4 extends App
{
    ...
    val isrt = new SortingT (a2)
    rk = isrt.iqsort2 ()
    println ("iqsort2 rk = " + stringOf (rk))                      // rank order
...
object SortingTTest5 extends App
{
    ...
    val srt = new SortingT (a1)
    srt.selsort2 ()
    println ("selsort2 a1 = " + stringOf (a1))
    println ("isSorted2   = " + srt.isSorted2)
    ...
    val isrt = new SortingT (a2)
    rk = isrt.iselsort2 ()
    println ("iselsort2 rk = " + stringOf (rk))                      // rank order
    println ("isiSorted2   = " + isrt.isiSorted2 (rk))
