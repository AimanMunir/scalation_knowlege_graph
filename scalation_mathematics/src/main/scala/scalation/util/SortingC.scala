...
class SortingC (a: Array [Complex])
{
     ...
     *  @see SortingC companion object's 'median3' function
...
object SortingC
{
     ...
     */
    @inline def median3 (a1: Complex, a2: Complex, a3: Complex): Complex =
    {
     ...
     */
    def median (a: Array [Complex], k_ : Int = -1): Complex =
    {
        val n = a.length
        val k = if (k_ < 0) (n+1) / 2 else k_
        (new SortingC (a)).median (k)
    } // median
