 ...
 *  Subset for the generic `MultiSet` data type that extends `ListBuffer`.
 */
class MultiSet [T] 
      extends ListBuffer [T] 
{ 
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
     ...
     *  @param b  the other `MultiSet`
     */
    def ⋃ (b: MultiSet [T]): ListBuffer [T] = super.union (b)
     ...
     *  @param b  the other `MultiSet`
     */
    def ⋂ (b: MultiSet [T]): ListBuffer [T] = super.intersect (b)
...
{   
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Create a `MultiSet` from a `ListBuffer`.
     *  @param ml  the mutable list of elements for the `MultiSet`
     */ 
    def apply [T] (list: ListBuffer [T]): MultiSet [T] =
    {
        val ms = new MultiSet [T] ()
        for (e <- list) ms += e
        ms
