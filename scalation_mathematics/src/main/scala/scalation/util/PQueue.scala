 ...
 */
class PQueue [T <: PQItem : ClassTag]
      extends ReArray [T] with Serializable
{
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 ...
 *  > runMain scalation.util.PQueueTest
 */
object PQueueTest extends App
{
    ...
    for (i <- 1 to 10) pq add new Element (10.0 * random)
    ...
    pq add e3
    println ("pq = " + pq)
    println ("found = " + (pq rem e3) + ", queue size = " + pq.size)
    println ("pq = " + pq)
