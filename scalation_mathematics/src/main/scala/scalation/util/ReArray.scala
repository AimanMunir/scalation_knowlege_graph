...
class ReArray [A] (_length: Int = 0, _array: Array [A] = null) (implicit arg0: ClassTag [A])
      ...
      with IndexedSeq [A]
//    with IndexedSeqOps [A, ReArray, ReArray [A]]
//    with StrictOptimizedSeqOps [A, ReArray, ReArray [A]]
//    with IterableFactoryDefaults [A, ReArray]
...
//      while (size0 > sz) { size0 -= 1; array(size0) = _ }
     ...
     */
    override def toString: String = "Re" + stringOf (array.slice (0, size0))
