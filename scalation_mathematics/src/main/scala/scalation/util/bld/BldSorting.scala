...
"""; val code2 = raw"""
     ...
     *  @see $SORTING companion object's 'median3' function
...
object $SORTING
{
     ...
     */
    @inline def median3 (a1: $BASE, a2: $BASE, a3: $BASE): $BASE =
    {
     ...
     */
    def median (a: Array [$BASE], k_ : Int = -1): $BASE =
    {
        val n = a.length
        val k = if (k_ < 0) (n+1) / 2 else k_
        (new $SORTING (a)).median (k)
    } // median
