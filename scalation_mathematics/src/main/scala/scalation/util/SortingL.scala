...
class SortingL (a: Array [Long])
{
     ...
     *  @see SortingL companion object's 'median3' function
...
object SortingL
{
     ...
     */
    @inline def median3 (a1: Long, a2: Long, a3: Long): Long =
    {
     ...
     */
    def median (a: Array [Long], k_ : Int = -1): Long =
    {
        val n = a.length
        val k = if (k_ < 0) (n+1) / 2 else k_
        (new SortingL (a)).median (k)
    } // median
