...
class Sorting [T <% Ordered[T]: ClassTag] (a: Array [T])
{
     ...
     *  @see `Sorting` companion object for 'median3' function
     *  @param i  element index 1
     *  @param j  element index 2
     *  @param k  element index 3
     */
    @inline final def med3 (i: Int, j: Int, k: Int): Int =
    {
