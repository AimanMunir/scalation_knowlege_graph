...
import scala.collection.{IterableFactoryDefaults, StrictOptimizedSeqOps}
...
class DArray [A] (_length: Int = 32768) (implicit arg0: ClassTag [A])
      ...
      with IndexedSeq [A]
//    with IndexedSeqOps [A, DArray, DArray [A]]
//    with StrictOptimizedSeqOps [A, DArray, DArray [A]]
//    with IterableFactoryDefaults [A, DArray]
      with DefaultSerializable
/* for 2.12
      extends IndexedSeq [A]
      with GenericTraversableTemplate [A, DArray]
      with IndexedSeqOptimized [A, DArray [A]]
*/
{ 
