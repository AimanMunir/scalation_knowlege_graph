...
class SortingQ (a: Array [Rational])
{
     ...
     *  @see SortingQ companion object's 'median3' function
...
object SortingQ
{
     ...
     */
    @inline def median3 (a1: Rational, a2: Rational, a3: Rational): Rational =
    {
     ...
     */
    def median (a: Array [Rational], k_ : Int = -1): Rational =
    {
        val n = a.length
        val k = if (k_ < 0) (n+1) / 2 else k_
        (new SortingQ (a)).median (k)
    } // median
