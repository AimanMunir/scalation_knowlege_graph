...
//import scalation.linalgebra.Vec_Elem.<                   // dependency on linalgebra
import scalation.math.PrimitiveType.<                      // dependency on math
...
*/
    ...
    val mat = Array (Array [Any] (2, 1, 1, 3, 2, 3, 1, 2, 3),   // col 0
                     Array [Any] (2, 1, 3, 3, 1, 1, 2, 2, 3))   // col 1
